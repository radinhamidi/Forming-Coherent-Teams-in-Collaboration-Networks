...
Rad = '../output/predictions/Rad_output.csv'
...
Coherent = '../output/predictions/Coherent_output.csv'

file_names = [OKLO, OKLU, OVAEO, OVAEU, SKLO, SKLU, SVAEO, SVAEU, Sapienza, Rad, SVDpp, RRN, BL2009, BL2017, Coherent]
# Asking models
