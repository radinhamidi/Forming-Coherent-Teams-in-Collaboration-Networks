...
# def pick_model(dataset_name, path='../output/Models/', custom_objects=None):
#     model_names = []
#     for path in glob.glob('{}/{}_*.json'.format(path, dataset_name)):
#         model_names.append(path)
#     print('Please enter you model number form list below:')
#     for i, path in enumerate(model_names):
#         print('{}. {}'.format(i + 1, path))
#     model_number = int(input('?')) - 1
#     json_file = open(model_names[model_number], 'r')
...
#         model_names.append(path)
#     print('Please enter your model number form list below:')
#     for i, path in enumerate(model_names):
#         print('{}. {}'.format(i + 1, path))
#     model_number = int(input('?')) - 1
